 ...
 * 1° Exercício
 *
 * Crie um programa que imprima na tela o seu nome, endereço, data de pagamento e o valor do salário.
 *
 * Exemplo:
 * Eu, Déryk Silva, morador de Sobradinho 2, confirmo que recebi o salário de 2150.00 na data = 05/05/2025!
 */

public class PrimeiroExercicioAula02 {
    public static void main(String[] args) {
        ...
        // Poderia usar também assim => System.out.println("Eu, " + nomeExercicio + ", morador de " + endereco + ", confirmo que recebi o salário de " + salarioVert + " na data = " + dataDePagamento);
    }
}
